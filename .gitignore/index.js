...
client.on("ready", () => {
    ...
    client.user.setActivity(`PN!help | By Kasumi | PN`,{type:"LISTENING"})
    })
    client.on("message", message => {
        ...
        if(message.content.includes("PN!help")){
            ...
            .setDescription("----------------------")
            .addField("Modération", "PN!kick, PN!ban, PN!clear")
            .addField("Information", "PN!info, PN!serverinfo")
            .addField("Raid", "PN!blacklist, PN!bot")
